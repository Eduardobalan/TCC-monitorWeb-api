...
@DatabaseSetup(value = InformacoesSwapServerTest.DATASET, type = DatabaseOperation.INSERT)
public class InformacoesSwapServerTest extends GenericTest {

    protected static final String DATASET = "classpath:/datasets/service/informacoesSwap.xml";
    ...
    public void buscarTodosTest() throws Exception {
        mockMvc.perform(get("/servidor/0/informacoesswap"))
    ...
    public void buscarTodosPorServidorTest() throws Exception {
        mockMvc.perform(get("/servidor/1/informacoesswap"))
                .andExpect(status().isOk())
    ...
    public void buscarPorIdTest() throws Exception {
        mockMvc.perform(get("/servidor/0/informacoesswap/1"))
                .andExpect(status().isOk())
    ...
    public void deletarTest() throws Exception {
        mockMvc.perform(delete("/servidor/0/informacoesswap/3"))
                .andExpect(status().isOk());
    ...
    public void deletarIdInexistenteTest() throws Exception {
        ...
        Exception expt = mockMvc.perform(delete("/servidor/0/informacoesswap/999999"))
    ...
    public void buscarIdInexistenteServidorTest() throws Exception {
        ...
        Exception expt =  mockMvc.perform(get("/servidor/99999999/informacoesswap"))
                .andExpect(status().isInternalServerError())
                .andReturn().getResolvedException();
